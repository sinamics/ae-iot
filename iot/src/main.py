...
class HeatController(object):
    ...
    def read_config(self):
        with open(os.path.expanduser('/opt/rpi-heater-logic/config.yaml'), "r") as yamlfile:
    ...
    def fetch_prices(self, *args):
        ...
        try:
            with open(os.path.expanduser('/opt/rpi-heater-logic/src/todays_prices.json'), "w") as outfile:
    ...
    def load_pricefile(self, *args):
        ...
        if not exists(os.path.expanduser('/opt/rpi-heater-logic/src/todays_prices.json')):
            self.fetch_prices()

        # Load file with todays prices
        with open(os.path.expanduser('/opt/rpi-heater-logic/src/todays_prices.json'), 'r') as openfile:   
